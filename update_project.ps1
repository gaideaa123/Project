...
$files = @(
 ...
 "oauth_helper.py", "web_uploader.py", "web_upload_engine.py", "web_gui_integration.py", "auto_publish_flow.py", "upload_state.py",
 ...
 "session_gui.py", "session_account_gui.py", "publishing_flow_gui.py", "direct_connection_policy.py", "target_reachability.py", "navigation_retry.py", "sitecustomize.py",
 ...
 "socks5_health_bridge_test.py", "guide_proxy_assignment_test.py", "direct_connection_policy_test.py", "target_reachability_test.py", "navigation_retry_test.py",
...
try {
 ...
 & $python (Join-Path $PSScriptRoot "navigation_retry_test.py")
 if ($LASTEXITCODE -ne 0) { throw "SOCKS5 navigation retry testi basarisiz" }
 ...
 & $python (Join-Path $PSScriptRoot "originality_qa_test.py")
 if ($LASTEXITCODE -ne 0) { throw "Ozgunluk QA testi basarisiz" }
 & $python (Join-Path $PSScriptRoot "auto_publish_flow_test.py")
