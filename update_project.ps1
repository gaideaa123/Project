...
$files = @(
  ...
  "session_gui.py", "sitecustomize.py", "media_qa.py", "antibot_resilience.py",
  "antibot_sandbox.py", "smoke_test.py", "preflight_smoke.py", "media_qa_smoke.py",
  "antibot_resilience_smoke.py", "antibot_sandbox_smoke.py", "runtime_contract_smoke.py",
...
try {
  ...
  Write-Host "`nHazir. Dogrudan calistir:" -ForegroundColor Green
